  ...
  useEffect(() => {
    ...
    const categoryOption = {
      ...
      series: [{
        ...
        data: [
          { value: 35, name: "Food & Dining", itemStyle: { color: "rgba(87, 181, 231, 1)" } },
          { value: 20, name: "Housing", itemStyle: { color: "rgba(141, 211, 199, 1)" } },
          { value: 15, name: "Transportation", itemStyle: { color: "rgba(251, 191, 114, 1)" } },
          { value: 30, name: "Entertainment", itemStyle: { color: "rgba(252, 141, 98, 1)" } },
        ],
      }],
    };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-[#1A1A1A] rounded-lg p-6 shadow-lg">
            ...
            <div id="categoryChart" className="w-full h-80" />
          </div>
          <div className="bg-[#1A1A1A] rounded-lg p-6 shadow-lg">
            <h3 className="text-xl font-semibold mb-4 text-white">
              Savings Growth
            </h3>
            <div id="savingsChart" className="w-full h-80" />
          </div>
        </div>
      </div>
    </section>
